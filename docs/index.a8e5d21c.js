var Swiper2 = function() {
        ...
        for(let a = 1; a < arguments.length; a += 1){
            ...
            if (null != i && (s = i, !("undefined" != typeof window && void 0 !== window.HTMLElement ? s instanceof HTMLElement : s && (1 === s.nodeType || 11 === s.nodeType)))) {
                ...
                for(let t = 0, a = s.length; t < a; t += 1){
                    ...
                    void 0 !== r && r.enumerable && (c(e[a]) && c(i[a]) ? i[a].__swiper2__ ? e[a] = i[a] : p(e[a], i[a]) : !c(e[a]) && c(i[a]) ? (e[a] = {}, i[a].__swiper2__ ? e[a] = i[a] : p(e[a], i[a])) : e[a] = i[a]);
                }
            }
        }
        var s;
    ...
    function m(e) {
        let { swiper2: t, targetPosition: s, side: a } = e;
    ...
    function h(e) {
        return e.querySelector(".swiper2-slide-transform") || e.shadowRoot && e.shadowRoot.querySelector(".swiper2-slide-transform") || e;
    }
    function f(e, t) {
        return void 0 === t && (t = ""), [
            ...e.children
    ...
    function L(e) {
        return void 0 === e && (e = {}), M || (M = function(e) {
            ...
            const s = P(), a = r(), i = a.navigator.platform, n = t || a.navigator.userAgent, l = {
                ios: !1,
                android: !1
    ...
    const z = (e, t)=>{
        ...
        const s = t.closest(e.isElement ? "swiper2-slide" : `.${e.params.slideClass}`);
        if (s) {
    ...
    var O = {
        ...
        updateSlides: function() {
            ...
            const s = e.params, { wrapperEl: a, slidesEl: i, size: r, rtlTranslate: n, wrongRTL: l } = e, o = e.virtual && s.virtual.enabled, d = o ? e.virtual.slides.length : e.slides.length, c = f(i, `.${e.params.slideClass}, swiper2-slide`), p = o ? e.virtual.slides.length : c.length;
            let m = [];
            const h = [], g = [];
            ...
            }), s.centeredSlides && s.cssMode && (u(a, "--swiper2-centered-offset-before", ""), u(a, "--swiper2-centered-offset-after", ""));
            ...
            for(let a = 0; a < p; a += 1){
                ...
                if (L = 0, c[a] && (i = c[a]), P && e.grid.updateSlide(a, i, c), !c[a] || "none" !== b(i, "display")) {
                    ...
                    c[a] && (c[a].swiper2SlideSize = L), g.push(L), s.centeredSlides ? (T = T + L / 2 + M / 2 + x, 0 === M && 0 !== a && (T = T - r / 2 - x), 0 === a && (T = T - r / 2 - x), Math.abs(T) < 0.001 && (T = 0), s.roundLengths && (T = Math.floor(T)), C % s.slidesPerGroup == 0 && m.push(T), h.push(T)) : (s.roundLengths && (T = Math.floor(T)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && m.push(T), h.push(T), T = T + L + x), e.virtualSize += L + x, M = L, C += 1;
                }
            }
            ...
            if (Object.assign(e, {
                ...
                u(a, "--swiper2-centered-offset-before", -m[0] + "px"), u(a, "--swiper2-centered-offset-after", e.size / 2 - g[g.length - 1] / 2 + "px");
        ...
        updateSlidesOffset: function() {
            ...
            for(let a = 0; a < t.length; a += 1)t[a].swiper2SlideOffset = (e.isHorizontal() ? t[a].offsetLeft : t[a].offsetTop) - s - e.cssOverflowAdjustment();
        },
        updateSlidesProgress: function(e) {
            void 0 === e && (e = this && this.translate || 0);
            const t = this, s = t.params, { slides: a, rtlTranslate: i, snapGrid: r } = t;
            if (0 === a.length) return;
            void 0 === a[0].swiper2SlideOffset && t.updateSlidesOffset();
            let n = -e;
            i && (n = e), a.forEach((e)=>{
            ...
            for(let e = 0; e < a.length; e += 1){
                const o = a[e];
                let d = o.swiper2SlideOffset;
                s.cssMode && s.centeredSlides && (d -= a[0].swiper2SlideOffset);
                const c = (n + (s.centeredSlides ? t.minTranslate() : 0) - d) / (o.swiper2SlideSize + l), p = (n - r[0] + (s.centeredSlides ? t.minTranslate() : 0) - d) / (o.swiper2SlideSize + l), u = -(n - d), m = u + t.slidesSizesGrid[e], h = u >= 0 && u <= t.size - t.slidesSizesGrid[e];
        ...
        updateSlidesClasses: function() {
            const e = this, { slides: t, params: s, slidesEl: a, activeIndex: i } = e, r = e.virtual && s.virtual.enabled, n = e.grid && s.grid && s.grid.rows > 1, l = (e)=>f(a, `.${s.slideClass}${e}, swiper2-slide${e}`)[0];
            let o, d, c;
            if (t.forEach((e)=>{
                ...
                if (s.loop) {
                    ...
                    t < 0 && (t = e.virtual.slides.length + t), t >= e.virtual.slides.length && (t -= e.virtual.slides.length), o = l(`[data-swiper2-slide-index="${t}"]`);
                } else o = l(`[data-swiper2-slide-index="${i}"]`);
            ...
            o && (o.classList.add(s.slideActiveClass), n ? (c && c.classList.add(s.slideNextClass), d && d.classList.add(s.slidePrevClass)) : (c = function(e, t) {
                ...
                return s;
            }(o, `.${s.slideClass}, swiper2-slide`)[0], s.loop && !c && (c = t[0]), c && c.classList.add(s.slideNextClass), d = function(e, t) {
                const s = [];
                ...
                return s;
            }(o, `.${s.slideClass}, swiper2-slide`)[0], s.loop, d && d.classList.add(s.slidePrevClass))), e.emitSlidesClasses();
        },
        updateActiveIndex: function(e) {
            ...
            if (t.virtual && i.virtual.enabled && i.loop) u = c(d);
                ...
                let s = parseInt(e.getAttribute("data-swiper2-slide-index"), 10);
                Number.isNaN(s) && (s = Math.max(t.slides.indexOf(e), 0)), u = Math.floor(s / i.grid.rows);
            } else if (t.slides[d]) {
                const e = t.slides[d].getAttribute("data-swiper2-slide-index");
                u = e ? parseInt(e, 10) : d;
            } else u = d;
            Object.assign(t, {
                previousSnapIndex: l,
        ...
        updateClickedSlide: function(e, t) {
            ...
            let i = e.closest(`.${a.slideClass}, swiper2-slide`);
            !i && s.isElement && t && t.length > 1 && t.includes(e) && [
                ...t.slice(t.indexOf(e) + 1, t.length)
            ].forEach((e)=>{
                !i && e.matches && e.matches(`.${a.slideClass}, swiper2-slide`) && (i = e);
            });
            let r, n = !1;
            if (i) {
            ...
            s.clickedSlide = i, s.virtual && s.params.virtual.enabled ? s.clickedIndex = parseInt(i.getAttribute("data-swiper2-slide-index"), 10) : s.clickedIndex = r, a.slideToClickedSlide && void 0 !== s.clickedIndex && s.clickedIndex !== s.activeIndex && s.slideToClickedSlide();
        }
    };
    var D = {
    ...
    function G(e) {
        let { swiper2: t, runCallbacks: s, direction: a, step: i } = e;
    ...
    var X = {
            ...
            if (i.params.loop) {
                if (i.virtual && i.params.virtual.enabled) n += i.virtual.slidesBefore;
                    ...
                    if (r) {
                        ...
                        e = i.slides.filter((e)=>1 * e.getAttribute("data-swiper2-slide-index") === t)[0].column;
                    ...
                    if (r) {
                        ...
                        n = i.slides.filter((t)=>1 * t.getAttribute("data-swiper2-slide-index") === e)[0].column;
        ...
        slideToClickedSlide: function() {
            ...
            const n = e.isElement ? "swiper2-slide" : `.${t.slideClass}`;
            if (t.loop) {
                if (e.animating) return;
                i = parseInt(e.clickedSlide.getAttribute("data-swiper2-slide-index"), 10), t.centeredSlides ? r < e.loopedSlides - a / 2 || r > e.slides.length - e.loopedSlides + a / 2 ? (e.loopFix(), r = e.getSlideIndex(f(s, `${n}[data-swiper2-slide-index="${i}"]`)[0]), l(()=>{
                    e.slideTo(r);
                })) : e.slideTo(r) : r > e.slides.length - a ? (e.loopFix(), r = e.getSlideIndex(f(s, `${n}[data-swiper2-slide-index="${i}"]`)[0]), l(()=>{
                    e.slideTo(r);
                })) : e.slideTo(r);
            } else e.slideTo(r);
        }
    ...
    var H = {
        loopCreate: function(e) {
            ...
            const i = ()=>{
                f(a, `.${s.slideClass}, swiper2-slide`).forEach((e, t)=>{
                    e.setAttribute("data-swiper2-slide-index", t);
                });
                ...
                for(let a = 0; a < e; a += 1){
                    const e = t.isElement ? v("swiper2-slide", [
                        s.slideBlankClass
                    ]) : v("div", [
                        s.slideClass,
                        s.slideBlankClass
            ...
            if (l) {
                ...
                else g("Swiper2 Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)");
                i();
            } else if (o) {
                if (s.loopAddBlankSlides) d(s.grid.rows - t.slides.length % s.grid.rows), t.recalcSlides(), t.updateSlides();
                else g("Swiper2 Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)");
                i();
            } else i();
            t.loopFix({
                slideRealIndex: e,
        ...
        loopFix: function(e) {
            ...
            d.length < f + w ? g("Swiper2 Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : b && "row" === m.grid.fill && g("Swiper2 Loop Warning: Loop mode is not compatible with grid.fill = `row`");
            const y = [], E = [];
            let x = o.activeIndex;
            void 0 === r ? r = o.getSlideIndex(d.filter((e)=>e.classList.contains(m.slideActiveClass))[0]) : x = r;
            const S = "next" === a || !a, T = "prev" === a || !a;
            let M = 0, C = 0;
            const P = b ? Math.ceil(d.length / m.grid.rows) : d.length, L = (b ? d[r].column : r) + (h && void 0 === i ? -f / 2 + 0.5 : 0);
            if (L < w) {
                M = Math.max(w - L, v);
            ...
            if (o.__preventObserver__ = !0, requestAnimationFrame(()=>{
                ...
                d[e].swiper2LoopMoveDOM = !0, u.prepend(d[e]), d[e].swiper2LoopMoveDOM = !1;
            }), S && E.forEach((e)=>{
                d[e].swiper2LoopMoveDOM = !0, u.append(d[e]), d[e].swiper2LoopMoveDOM = !1;
        ...
        loopDestroy: function() {
            ...
            const a = [];
            e.slides.forEach((e)=>{
                const t = void 0 === e.swiper2SlideIndex ? 1 * e.getAttribute("data-swiper2-slide-index") : e.swiper2SlideIndex;
                a[t] = e;
            }), e.slides.forEach((e)=>{
                e.removeAttribute("data-swiper2-slide-index");
            }), a.forEach((e)=>{
                s.append(e);
    ...
    function B(e) {
        ...
        if (p.preventedByNestedSwiper2) return n.startX = u, void (n.startY = m);
        ...
        }), i.currentTranslate < s.maxTranslate() && (E = !1, r.resistance && (i.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - g) ** x))), E && (p.preventedByNestedSwiper2 = !0), !s.allowSlideNext && "next" === s.swipeDirection && i.currentTranslate < i.startTranslate && (i.currentTranslate = i.startTranslate), !s.allowSlidePrev && "prev" === s.swipeDirection && i.currentTranslate > i.startTranslate && (i.currentTranslate = i.startTranslate), s.allowSlidePrev || s.allowSlideNext || (i.currentTranslate = i.startTranslate), r.threshold > 0) {
    ...
    var K = {
        ...
        swipeHandler: null,
        noSwiping: !0,
        noSwipingClass: "swiper2-no-swiping",
        noSwipingSelector: null,
        passiveListeners: !0,
        maxBackfaceHiddenSlides: 10,
        containerModifierClass: "swiper2-",
        slideClass: "swiper2-slide",
        slideBlankClass: "swiper2-slide-blank",
        slideActiveClass: "swiper2-slide-active",
        slideVisibleClass: "swiper2-slide-visible",
        slideFullyVisibleClass: "swiper2-slide-fully-visible",
        slideNextClass: "swiper2-slide-next",
        slidePrevClass: "swiper2-slide-prev",
        wrapperClass: "swiper2-wrapper",
        lazyPreloaderClass: "swiper2-lazy-preloader",
    ...
    const Q = {
        ...
        breakpoints: {
            setBreakpoint: function() {
                ...
                const l = (n in r ? r[n] : void 0) || e.originalParams, o = U(e, a), d = U(e, l), c = a.enabled;
    ...
    class ee {
        constructor(){
            ...
            const l = this;
            l.__swiper2__ = !0, l.support = P(), l.device = L({
            ...
            return l.params = p({}, d, J, t), l.originalParams = p({}, l.params), l.passedParams = p({}, t), l.params && l.params.on && Object.keys(l.params.on).forEach((e)=>{
                ...
                imagesToLoad: [],
                imagesLoaded: 0
            }), l.emit("_swiper2"), l.params.init && l.init(), l;
        }
        getDirectionLabel(e) {
        ...
        getSlideIndex(e) {
            const { slidesEl: t, params: s } = this, a = y(f(t, `.${s.slideClass}, swiper2-slide`)[0]);
            return y(e) - a;
        }
        getSlideIndexByData(e) {
            return this.getSlideIndex(this.slides.filter((t)=>1 * t.getAttribute("data-swiper2-slide-index") === e)[0]);
        }
        recalcSlides() {
            const { slidesEl: e, params: t } = this;
            this.slides = f(e, `.${t.slideClass}, swiper2-slide`);
        }
        enable() {
            const e = this;
        ...
        emitContainerClasses() {
            ...
            const t = e.el.className.split(" ").filter((t)=>0 === t.indexOf("swiper2") || 0 === t.indexOf(e.params.containerModifierClass));
            e.emit("_containerClasses", t.join(" "));
        }
        getSlideClasses(e) {
            const t = this;
            return t.destroyed ? "" : e.className.split(" ").filter((e)=>0 === e.indexOf("swiper2-slide") || 0 === e.indexOf(t.params.slideClass)).join(" ");
        }
        emitSlidesClasses() {
            const e = this;
            if (!e.params._emitClasses || !e.el) return;
        ...
        slidesPerViewDynamic(e, t) {
            ...
            if (s.centeredSlides) {
                let e, t = a[l] ? a[l].swiper2SlideSize : 0;
                for(let s = l + 1; s < a.length; s += 1)a[s] && !e && (t += a[s].swiper2SlideSize, o += 1, t > n && (e = !0));
                for(let s = l - 1; s >= 0; s -= 1)a[s] && !e && (t += a[s].swiper2SlideSize, o += 1, t > n && (e = !0));
        ...
        mount(e) {
            ...
            s.swiper2 = t, s.parentNode && s.parentNode.host && "SWIPER2-CONTAINER" === s.parentNode.host.nodeName && (t.isElement = !0);
        ...
        destroy(e, t) {
            ...
            return void 0 === s.params || s.destroyed || (s.emit("beforeDestroy"), s.initialized = !1, s.detachEvents(), a.loop && s.loopDestroy(), t && (s.removeClasses(), i.removeAttribute("style"), r.removeAttribute("style"), n && n.length && n.forEach((e)=>{
                e.classList.remove(a.slideVisibleClass, a.slideFullyVisibleClass, a.slideActiveClass, a.slideNextClass, a.slidePrevClass), e.removeAttribute("style"), e.removeAttribute("data-swiper2-slide-index");
            })), s.emit("destroy"), Object.keys(s.eventsListeners).forEach((e)=>{
                s.off(e);
            }), !1 !== e && (s.el.swiper2 = null, function(e) {
                const t = e;
    ...
    function oe(e) {
        const { effect: t, swiper2: s, on: a, setTranslate: i, setTransition: r, overwriteParams: n, perspective: l, recreateShadows: o, getEffectParams: d } = e;
        let c;
        a("beforeInit", ()=>{
            ...
            if (s.params.effect === t && o) {
                ...
                s.slides.forEach((e)=>{
                    e.querySelectorAll(".swiper2-slide-shadow-top, .swiper2-slide-shadow-right, .swiper2-slide-shadow-bottom, .swiper2-slide-shadow-left").forEach((e)=>e.remove());
                }), o();
            }
        }), a("virtualUpdate", ()=>{
    ...
    function ce(e) {
        let { swiper2: t, duration: s, transformElements: a, allSlides: i } = e;
        const { activeIndex: r } = t;
        if (t.params.virtualTranslate && 0 !== s) {
            let e, s = !1;
            e = i ? a : a.filter((e)=>{
                const s = e.classList.contains("swiper2-slide-transform") ? ((e)=>{
    ...
    function pe(e, t, s) {
        const a = `swiper2-slide-shadow${s ? `-${s}` : ""}${e ? ` swiper2-slide-shadow-${e}` : ""}`, i = h(t);
    ...
    Object.keys(Q).forEach((e)=>{
        ...
        function(e) {
            let { swiper2: t, extendParams: s, on: a, emit: i } = e;
    ...
    const ue = [
        function(e) {
            let t, { swiper2: s, extendParams: i, on: r, emit: n } = e;
            i({
                virtual: {
                    enabled: !1,
                    slides: [],
            ...
            function d(e, t) {
                ...
                let i;
                return a.renderSlide ? (i = a.renderSlide.call(s, e, t), "string" == typeof i && (o.innerHTML = i, i = o.children[0])) : i = s.isElement ? v("swiper2-slide") : v("div", s.params.slideClass), i.setAttribute("data-swiper2-slide-index", t), a.renderSlide || (i.innerHTML = e), a.cache && (s.virtual.cache[t] = i), i;
            }
            function c(e) {
                ...
                if (e) s.slides.filter((e)=>e.matches(`.${s.params.slideClass}, swiper2-slide`)).forEach((e)=>{
                    e.remove();
                });
                else for(let e = c; e <= p; e += 1)if (e < y || e > E) {
                    const t = C(e);
                    s.slides.filter((e)=>e.matches(`.${s.params.slideClass}[data-swiper2-slide-index="${t}"], swiper2-slide[data-swiper2-slide-index="${t}"]`)).forEach((e)=>{
                        e.remove();
                    });
                }
                ...
                f(s.slidesEl, ".swiper2-slide, swiper2-slide").forEach((e)=>{
                    e.style[v] = x - Math.abs(s.cssOverflowAdjustment()) + "px";
                }), S();
            }
            r("beforeInit", ()=>{
                ...
                if (void 0 === s.passedParams.virtual.slides) {
                    const t = [
                        ...s.slidesEl.children
                    ].filter((e)=>e.matches(`.${s.params.slideClass}, swiper2-slide`));
                    t && t.length && (s.virtual.slides = [
                        ...t
                    ], e = !0, t.forEach((e, t)=>{
                        e.setAttribute("data-swiper2-slide-index", t), s.virtual.cache[t] = e, e.remove();
                    }));
                }
                ...
                s.params.virtual.enabled && s.params.cssMode && u(s.wrapperEl, "--swiper2-virtual-size", `${s.virtualSize}px`);
                ...
                prependSlide: function(e) {
                    ...
                    if (s.params.virtual.cache) {
                        ...
                        Object.keys(e).forEach((s)=>{
                            const a = e[s], r = a.getAttribute("data-swiper2-slide-index");
                            r && a.setAttribute("data-swiper2-slide-index", parseInt(r, 10) + i), t[parseInt(s, 10) + i] = a;
                        }), s.virtual.cache = t;
                    }
                    c(!0), s.slideTo(a, 0);
                },
                removeSlide: function(e) {
                    ...
                    if (Array.isArray(e)) for(let a = e.length - 1; a >= 0; a -= 1)s.params.virtual.cache && (delete s.virtual.cache[e[a]], Object.keys(s.virtual.cache).forEach((t)=>{
                        t > e && (s.virtual.cache[t - 1] = s.virtual.cache[t], s.virtual.cache[t - 1].setAttribute("data-swiper2-slide-index", t - 1), delete s.virtual.cache[t]);
        ...
        function(e) {
            let { swiper2: t, extendParams: s, on: i, emit: n } = e;
            const l = a(), o = r();
            function d(e) {
                if (!t.enabled) return;
                ...
                if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || l.activeElement && l.activeElement.nodeName && ("input" === l.activeElement.nodeName.toLowerCase() || "textarea" === l.activeElement.nodeName.toLowerCase()))) {
                    if (t.params.keyboard.onlyInViewport && (d || c || p || u || m || h)) {
                        let e = !1;
                        if (E(t.el, `.${t.params.slideClass}, swiper2-slide`).length > 0 && 0 === E(t.el, `.${t.params.slideActiveClass}`).length) return;
        ...
        function(e) {
            ...
            s({
                mousewheel: {
                    ...
                    thresholdDelta: null,
                    thresholdTime: null,
                    noMousewheelClass: "swiper2-no-mousewheel"
                }
            }), t.mousewheel = {
                enabled: !1
            };
        ...
        function(e) {
            ...
            s({
                navigation: {
                    ...
                    hiddenClass: "swiper2-button-hidden",
                    lockClass: "swiper2-button-lock",
                    navigationDisabledClass: "swiper2-navigation-disabled"
                }
            }), t.navigation = {
                nextEl: null,
                prevEl: null
        ...
        function(e) {
            ...
            function h() {
                ...
                ], s.length > 1 && (s = s.filter((e)=>E(e, ".swiper2")[0] === t.el)[0])), Array.isArray(s) && 1 === s.length && (s = s[0]), Object.assign(t.pagination, {
                    el: s
                }), s = o(s), s.forEach((s)=>{
        ...
        function(e) {
            let { swiper2: t, extendParams: s, on: i, emit: r } = e;
            const o = a();
            ...
            s({
                scrollbar: {
                    ...
                    draggable: !1,
                    snapOnRelease: !0,
                    lockClass: "swiper2-scrollbar-lock",
                    dragClass: "swiper2-scrollbar-drag",
                    scrollbarDisabledClass: "swiper2-scrollbar-disabled",
                    horizontalClass: "swiper2-scrollbar-horizontal",
                    verticalClass: "swiper2-scrollbar-vertical"
                }
            }), t.scrollbar = {
                el: null,
                dragEl: null
        ...
        function(e) {
            let { swiper2: t, extendParams: s, on: a } = e;
            s({
                parallax: {
                    enabled: !1
                }
            });
            const i = "[data-swiper2-parallax], [data-swiper2-parallax-x], [data-swiper2-parallax-y], [data-swiper2-parallax-opacity], [data-swiper2-parallax-scale]", r = (e, s)=>{
                const { rtl: a } = t, i = a ? -1 : 1, r = e.getAttribute("data-swiper2-parallax") || "0";
                let n = e.getAttribute("data-swiper2-parallax-x"), l = e.getAttribute("data-swiper2-parallax-y");
                const o = e.getAttribute("data-swiper2-parallax-scale"), d = e.getAttribute("data-swiper2-parallax-opacity"), c = e.getAttribute("data-swiper2-parallax-rotate");
                ...
                t.isElement && o.push(...f(t.hostEl, i)), o.forEach((e)=>{
                    ...
                    let l = e.progress;
                    t.params.slidesPerGroup > 1 && "auto" !== t.params.slidesPerView && (l += Math.ceil(s / 2) - a * (n.length - 1)), l = Math.min(Math.max(l, -1), 1), e.querySelectorAll(`${i}, [data-swiper2-parallax-rotate]`).forEach((e)=>{
                        r(e, l);
                    });
                });
            };
            a("beforeInit", ()=>{
                ...
                t.params.parallax.enabled && function(e) {
                    ...
                    t.isElement && r.push(...a.querySelectorAll(i)), r.forEach((t)=>{
                        let s = parseInt(t.getAttribute("data-swiper2-parallax-duration"), 10) || e;
        ...
        function(e) {
            ...
            s({
                zoom: {
                    ...
                    minRatio: 1,
                    toggle: !0,
                    containerClass: "swiper2-zoom-container",
                    zoomedSlideClass: "swiper2-slide-zoomed"
                }
            }), t.zoom = {
                enabled: !1
            };
            ...
            function y(e) {
                const s = t.isElement ? "swiper2-slide" : `.${t.params.slideClass}`;
            ...
            function x(e) {
                ...
                if (l = !1, o = !1, u.push(e), !(u.length < 2)) {
                    if (l = !0, m.scaleStart = b(), !m.slideEl) {
                        m.slideEl = e.target.closest(`.${t.params.slideClass}, swiper2-slide`), m.slideEl || (m.slideEl = t.slides[t.activeIndex]);
                        let a = m.slideEl.querySelector(`.${s.containerClass}`);
                        if (a && (a = a.querySelectorAll("picture, img, svg, canvas, .swiper2-zoom-target")[0]), m.imageEl = a, m.imageWrapEl = a ? E(m.imageEl, `.${s.containerClass}`)[0] : void 0, !m.imageWrapEl) return void (m.imageEl = void 0);
                        m.maxRatio = m.imageWrapEl.getAttribute("data-swiper2-zoom") || s.maxRatio;
                    }
                    if (m.imageEl) {
                        const [e, t] = function() {
            ...
            function P(e) {
                ...
                if (!m.slideEl) {
                    e && e.target && (m.slideEl = e.target.closest(`.${t.params.slideClass}, swiper2-slide`)), m.slideEl || (t.params.virtual && t.params.virtual.enabled && t.virtual ? m.slideEl = f(t.slidesEl, `.${t.params.slideActiveClass}`)[0] : m.slideEl = t.slides[t.activeIndex]);
                    let s = m.slideEl.querySelector(`.${a.containerClass}`);
                    s && (s = s.querySelectorAll("picture, img, svg, canvas, .swiper2-zoom-target")[0]), m.imageEl = s, m.imageWrapEl = s ? E(m.imageEl, `.${a.containerClass}`)[0] : void 0;
                }
                if (!m.imageEl || !m.imageWrapEl) return;
                let i, r, l, o, d, p, u, g, v, b, y, x, S, T, M, C, P, L;
                t.params.cssMode && (t.wrapperEl.style.overflow = "hidden", t.wrapperEl.style.touchAction = "none"), m.slideEl.classList.add(`${a.zoomedSlideClass}`), void 0 === h.touchesStart.x && e ? (i = e.pageX, r = e.pageY) : (i = h.touchesStart.x, r = h.touchesStart.y);
                const A = "number" == typeof e ? e : null;
                1 === c && A && (i = void 0, r = void 0), s.scale = A || m.imageWrapEl.getAttribute("data-swiper2-zoom") || a.maxRatio, c = A || m.imageWrapEl.getAttribute("data-swiper2-zoom") || a.maxRatio, !e || 1 === c && A ? (u = 0, g = 0) : (P = m.slideEl.offsetWidth, L = m.slideEl.offsetHeight, l = w(m.slideEl).left + n.scrollX, o = w(m.slideEl).top + n.scrollY, d = l + P / 2 - i, p = o + L / 2 - r, v = m.imageEl.offsetWidth, b = m.imageEl.offsetHeight, y = v * s.scale, x = b * s.scale, S = Math.min(P / 2 - y / 2, 0), T = Math.min(L / 2 - x / 2, 0), M = -S, C = -T, u = d * s.scale, g = p * s.scale, u < S && (u = S), u > M && (u = M), g < T && (g = T), g > C && (g = C)), A && 1 === s.scale && (m.originX = 0, m.originY = 0), m.imageWrapEl.style.transitionDuration = "300ms", m.imageWrapEl.style.transform = `translate3d(${u}px, ${g}px,0)`, m.imageEl.style.transitionDuration = "300ms", m.imageEl.style.transform = `translate3d(0,0,0) scale(${s.scale})`;
            }
            function L() {
                ...
                if (!m.slideEl) {
                    ...
                    e && (e = e.querySelectorAll("picture, img, svg, canvas, .swiper2-zoom-target")[0]), m.imageEl = e, m.imageWrapEl = e ? E(m.imageEl, `.${s.containerClass}`)[0] : void 0;
                }
        ...
        function(e) {
            ...
            s({
                ...
                if ("undefined" != typeof window && ("string" == typeof t.params.controller.control || t.params.controller.control instanceof HTMLElement)) {
                    ...
                    if (e && e.swiper2) t.controller.control = e.swiper2;
                    else if (e) {
                        const s = (a)=>{
        ...
        function(e) {
            ...
            s({
                a11y: {
                    enabled: !0,
                    notificationClass: "swiper2-notification",
            ...
            const w = (e, t, s)=>{
                ...
                const s = e.target.closest(`.${t.params.slideClass}, swiper2-slide`);
                ...
                e.slideLabelMessage && t.slides.forEach((a, i)=>{
                    const r = t.params.loop ? parseInt(a.getAttribute("data-swiper2-slide-index"), 10) : i;
                ...
                const a = t.wrapperEl, r = e.id || a.getAttribute("id") || `swiper2-wrapper-${l = 16, void 0 === l && (l = 16), "x".repeat(l).replace(/x/g, ()=>Math.round(16 * Math.random()).toString(16))}`;
                var l;
                ...
                if (u = n(u), m = n(m), u && u.forEach((t)=>w(t, r, e.nextSlideMessage)), m && m.forEach((t)=>w(t, r, e.prevSlideMessage)), g()) n(t.pagination.el).forEach((e)=>{
        ...
        function(e) {
            let { swiper2: t, extendParams: s, emit: i, on: n } = e, l = !1;
            const o = a(), d = r();
            s({
                hashNavigation: {
                    enabled: !1,
                    ...
                    getSlideIndex (e, s) {
                        if (t.virtual && t.params.virtual.enabled) {
                            ...
                            if (!e) return 0;
                            return parseInt(e.getAttribute("data-swiper2-slide-index"), 10);
                        }
                        return t.getSlideIndex(f(t.slidesEl, `.${t.params.slideClass}[data-hash="${s}"], swiper2-slide[data-hash="${s}"]`)[0]);
                    }
                }
            });
            const c = ()=>{
                i("hashChange");
                const e = o.location.hash.replace("#", ""), s = t.virtual && t.params.virtual.enabled ? t.slidesEl.querySelector(`[data-swiper2-slide-index="${t.activeIndex}"]`) : t.slides[t.activeIndex];
                ...
                const e = t.virtual && t.params.virtual.enabled ? t.slidesEl.querySelector(`[data-swiper2-slide-index="${t.activeIndex}"]`) : t.slides[t.activeIndex], s = e ? e.getAttribute("data-hash") || e.getAttribute("data-history") : "";
        ...
        function(e) {
            let t, s, { swiper2: i, extendParams: r, on: n, emit: l, params: o } = e;
            i.autoplay = {
                running: !1,
                paused: !1,
                timeLeft: 0
            ...
            const E = ()=>{
                ...
                const r = (()=>{
                    let e;
                    if (e = i.virtual && i.params.virtual.enabled ? i.slides.filter((e)=>e.classList.contains("swiper2-slide-active"))[0] : i.slides[i.activeIndex], !e) return;
                    return parseInt(e.getAttribute("data-swiper2-autoplay"), 10);
                })();
        ...
        function(e) {
            let { swiper2: t, extendParams: s, on: i } = e;
            s({
                thumbs: {
                    swiper2: null,
                    multipleActiveThumbs: !0,
                    autoScrollOffset: 0,
                    slideThumbActiveClass: "swiper2-slide-thumb-active",
                    thumbsContainerClass: "swiper2-thumbs"
                }
            });
            let r = !1, n = !1;
            function l() {
                const e = t.thumbs.swiper2;
                if (!e || e.destroyed) return;
                const s = e.clickedIndex, a = e.clickedSlide;
                if (a && a.classList.contains(t.params.thumbs.slideThumbActiveClass)) return;
                if (null == s) return;
                let i;
                i = e.params.loop ? parseInt(e.clickedSlide.getAttribute("data-swiper2-slide-index"), 10) : s, t.params.loop ? t.slideToLoop(i) : t.slideTo(i);
            }
            function o() {
                ...
                if (e.swiper2 instanceof s) t.thumbs.swiper2 = e.swiper2, Object.assign(t.thumbs.swiper2.originalParams, {
                    watchSlidesProgress: !0,
                    slideToClickedSlide: !1
                }), Object.assign(t.thumbs.swiper2.params, {
                    watchSlidesProgress: !0,
                    slideToClickedSlide: !1
                }), t.thumbs.swiper2.update();
                else if (c(e.swiper2)) {
                    const a = Object.assign({}, e.swiper2);
                    Object.assign(a, {
                        watchSlidesProgress: !0,
                        slideToClickedSlide: !1
                    }), t.thumbs.swiper2 = new s(a), n = !0;
                }
                return t.thumbs.swiper2.el.classList.add(t.params.thumbs.thumbsContainerClass), t.thumbs.swiper2.on("tap", l), !0;
            }
            function d(e) {
                const s = t.thumbs.swiper2;
                if (!s || s.destroyed) return;
                const a = "auto" === s.params.slidesPerView ? s.slidesPerViewDynamic() : s.params.slidesPerView;
                let i = 1;
                const r = t.params.thumbs.slideThumbActiveClass;
                if (t.params.slidesPerView > 1 && !t.params.centeredSlides && (i = t.params.slidesPerView), t.params.thumbs.multipleActiveThumbs || (i = 1), i = Math.floor(i), s.slides.forEach((e)=>e.classList.remove(r)), s.params.loop || s.params.virtual && s.params.virtual.enabled) for(let e = 0; e < i; e += 1)f(s.slidesEl, `[data-swiper2-slide-index="${t.realIndex + e}"]`).forEach((e)=>{
                    e.classList.add(r);
                });
                ...
                if (t.realIndex !== s.realIndex || l) {
                    ...
                    let r, o;
                    if (s.params.loop) {
                        const e = s.slides.filter((e)=>e.getAttribute("data-swiper2-slide-index") === `${t.realIndex}`)[0];
            ...
            t.thumbs = {
                ...
                const { thumbs: e } = t.params;
                if (e && e.swiper2) {
                    if ("string" == typeof e.swiper2 || e.swiper2 instanceof HTMLElement) {
                        const s = a(), i = ()=>{
                            const a = "string" == typeof e.swiper2 ? s.querySelector(e.swiper2) : e.swiper2;
                            if (a && a.swiper2) e.swiper2 = a.swiper2, o(), d(!0);
                            else if (a) {
                                const s = (i)=>{
                                    e.swiper2 = i.detail[0], a.removeEventListener("init", s), o(), d(!0), e.swiper2.update(), t.update();
                                };
        ...
        function(e) {
            let { swiper2: t, extendParams: s, emit: a, once: i } = e;
            s({
                freeMode: {
                    enabled: !1,
                    momentum: !0,
        ...
        function(e) {
            let t, s, a, i, { swiper2: r, extendParams: n, on: l } = e;
            n({
                grid: {
                    rows: 1,
                    fill: "column"
            ...
            l("init", ()=>{
                ...
                unsetSlides: ()=>{
                    r.slides && r.slides.forEach((e)=>{
                        e.swiper2SlideGridSet && (e.style.height = "", e.style[r.getDirectionLabel("margin-top")] = "");
                    });
                },
                updateSlide: (e, i, n)=>{
                    ...
                    i.row = f, i.column = h, i.style.height = `calc((100% - ${(c - 1) * d}px) / ${c})`, i.style[r.getDirectionLabel("margin-top")] = 0 !== f ? d && `${d}px` : "", i.swiper2SlideGridSet = !0;
                },
        ...
        function(e) {
            ...
            const i = (e, t, s)=>{
                let a = s ? e.querySelector(".swiper2-slide-shadow-left") : e.querySelector(".swiper2-slide-shadow-top"), i = s ? e.querySelector(".swiper2-slide-shadow-right") : e.querySelector(".swiper2-slide-shadow-bottom");
                a || (a = v("div", ("swiper2-slide-shadow-cube swiper2-slide-shadow-" + (s ? "left" : "top")).split(" ")), e.append(a)), i || (i = v("div", ("swiper2-slide-shadow-cube swiper2-slide-shadow-" + (s ? "right" : "bottom")).split(" ")), e.append(i)), a && (a.style.opacity = Math.max(-t, 0)), i && (i.style.opacity = Math.max(t, 0));
            };
            oe({
                effect: "cube",
                swiper2: t,
                ...
                setTranslate: ()=>{
                    ...
                    let m, h = 0;
                    c.shadow && (p ? (m = t.wrapperEl.querySelector(".swiper2-cube-shadow"), m || (m = v("div", "swiper2-cube-shadow"), t.wrapperEl.append(m)), m.style.height = `${r}px`) : (m = e.querySelector(".swiper2-cube-shadow"), m || (m = v("div", "swiper2-cube-shadow"), e.append(m))));
                    for(let e = 0; e < a.length; e += 1){
                        const s = a[e];
                        let r = e;
                        u && (r = parseInt(s.getAttribute("data-swiper2-slide-index"), 10));
                    ...
                    s.style.transform = `translate3d(0px,0,${f}px) rotateX(${t.isHorizontal() ? 0 : h}deg) rotateY(${t.isHorizontal() ? -h : 0}deg)`, s.style.setProperty("--swiper2-cube-translate-z", `${f}px`);
                },
                setTransition: (e)=>{
                    const { el: s, slides: a } = t;
                    if (a.forEach((t)=>{
                        t.style.transitionDuration = `${e}ms`, t.querySelectorAll(".swiper2-slide-shadow-top, .swiper2-slide-shadow-right, .swiper2-slide-shadow-bottom, .swiper2-slide-shadow-left").forEach((t)=>{
                            t.style.transitionDuration = `${e}ms`;
                        });
                    }), t.params.cubeEffect.shadow && !t.isHorizontal()) {
                        const t = s.querySelector(".swiper2-cube-shadow");
        ...
        function(e) {
            ...
            const i = (e, s)=>{
                let a = t.isHorizontal() ? e.querySelector(".swiper2-slide-shadow-left") : e.querySelector(".swiper2-slide-shadow-top"), i = t.isHorizontal() ? e.querySelector(".swiper2-slide-shadow-right") : e.querySelector(".swiper2-slide-shadow-bottom");
            ...
            s({
                ...
                setTranslate: ()=>{
                    ...
                    for(let e = 0, s = a.length; e < s; e += 1){
                        const s = a[e], l = i[e], p = (o - s.swiper2SlideOffset - l / 2) / l, u = "function" == typeof r.modifier ? r.modifier(p) : p * r.modifier;
                        ...
                        if (de(0, s).style.transform = y, s.style.zIndex = 1 - Math.abs(Math.round(u)), r.slideShadows) {
                            let e = n ? s.querySelector(".swiper2-slide-shadow-left") : s.querySelector(".swiper2-slide-shadow-top"), t = n ? s.querySelector(".swiper2-slide-shadow-right") : s.querySelector(".swiper2-slide-shadow-bottom");
            ...
            oe({
                ...
                setTranslate: ()=>{
                    ...
                    for(let s = 0; s < e.length; s += 1){
                        ...
                        const p = a.swiper2SlideOffset, u = [
                        ...
                        if (h && f.shadow || !h) {
                            let e = a.querySelector(".swiper2-slide-shadow");
                ...
                setTransition: (e)=>{
                    const s = t.slides.map((e)=>h(e));
                    s.forEach((t)=>{
                        t.style.transitionDuration = `${e}ms`, t.querySelectorAll(".swiper2-slide-shadow").forEach((t)=>{
                            t.style.transitionDuration = `${e}ms`;
                        });
                    }), ce({
                        swiper2: t,
            ...
            s({
                ...
                setTranslate: ()=>{
                    ...
                    for(let o = 0; o < e.length; o += 1){
                        ...
                        let u = d.swiper2SlideOffset;
                        t.params.centeredSlides && !t.params.cssMode && (t.wrapperEl.style.transform = `translateX(${t.minTranslate()}px)`), t.params.centeredSlides && t.params.cssMode && (u -= e[0].swiper2SlideOffset);
                        ...
                        if (i.slideShadows) {
                            let e = d.querySelector(".swiper2-slide-shadow");
...
//# sourceMappingURL=index.a8e5d21c.js.map
